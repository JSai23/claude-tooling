...
- **backlinks** — focused on one note's links. Use when you know the note.
- **find-connections** — broad exploration across the vault. Use when mapping a topic or area.
- **sem-search** — raw search results. Use when you just need to find notes.
